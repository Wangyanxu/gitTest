...
/*!
 joinChatRoom 标记
 */
FOUNDATION_EXTERN NSString *const RongRTCLogJoinChatRoomTag;

#pragma mark - ChatRoomKVSync
/*!
 ChatRoomKVSync 标记 --kv同步回调
*/
FOUNDATION_EXTERN NSString *const RongRTCLogChatRoomKVSyncTag;

#pragma mark - ChatRoomKVUpdate
/*!
 ChatRoomKVUpdate 标记 --kv更新回调
 */
FOUNDATION_EXTERN NSString *const RongRTCLogChatRoomKVUpdateTag;
...
#pragma mark - leaveChatRoom
/*!
 leaveChatRoom 标记
 */
FOUNDATION_EXTERN NSString *const RongRTCLogLeaveChatRoomTag;
